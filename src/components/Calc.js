var volume = document.querySelector('#volumeV')
var but = document.querySelector('#buttonIBU')
var ibu = document.querySelector('#RESULT')
var plato = document.querySelector('#OG')
var mass = document.querySelector('#MASS')
var alpha = document.querySelector('#ALPHA')
var boiltime = document.querySelector('#TIME')


var og = [1.030, 1.040, 1.050, 1.060, 1.070];

var boil = [5, 10, 15, 20, 30, 40, 60, 80, 90, 120];

var numstring =[00, 10, 20, 30, 40, 01, 11, 21, 31, 41, 02, 12, 22, 32, 42, 03, 13, 23, 33, 34, 04, 14, 24, 34, 44, 05, 15, 25, 35, 45, 06, 16, 26, 36, 46, 07, 17, 27, 37, 47, 08, 18, 28, 38, 48, 09, 19, 29, 39, 49];
