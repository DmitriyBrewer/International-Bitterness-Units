...
//Handle Submit IBU
    function handleSubmit(e){
      e.preventDefault();
      if (volume === "" || plato === "" || nameHops === "" || boil === "" || amount === "" || alpha === "" || timeHops === ""){} else 
      setibuSubmit(IBU());}
//Handle Submit IBU
    ...
    function Submit(e){
      switch (e.target.name){
        case 'PLATO':
          ...
          newClassOG('but');
          setSpan(''); //состояние видимости input plato
      ...
      break;
        ...
        case 'SG':
          ...
          newClassPlato('but');
          newClassOG('butPurp');
          setSpan('inPut-hidden');
          setSpan2('')
          setplatoH1('h1styleHidden');//скрываем текст ошибки (избегаем наложения)
      ...
      function blurHandler(e){
        switch (e.target.name){
          ...
          break;
            ...
            default://иначе ругается Expected a default case default-case
        };
      };
//Blurhandlers
...
// Calculate
  // IBU calс основная функция калькуляции 
      function IBU(){
  ...
  //KOEF функция подбора коэффицента изомеризации
