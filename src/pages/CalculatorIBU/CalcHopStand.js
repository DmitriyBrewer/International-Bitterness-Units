export const CalcHopStand = (
  ...
  var ibu =
    ...
    KOEF(OGSG(destiny), boil);
    // const ibutime = ibu + (time1*0.1);
    const temp = ibu * (temperature/100)
    const ibuHopStand = temp + (time1/temp)
    // const ibuHopStand = 
    const parsIBU1 = parseFloat(ibuHopStand.toFixed(1));
