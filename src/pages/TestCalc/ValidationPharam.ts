...
export const destinyValidations = (destiny: string | undefined, destinyType: string|undefined) => {
...
export const timeValidations = (time: string | undefined, boil: string | undefined) => {
